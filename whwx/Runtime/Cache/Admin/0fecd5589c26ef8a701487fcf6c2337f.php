...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> <h3 class="page-header">分类管理<small><?php if(($info["id"]) > "0"): ?>/修改<?php else: ?>/添加<?php endif; ?></small></h3></div>
<div class="row">
	<div class="panel panel-default">
		<div class="panel-body">
			<form id="myform" class="form-horizontal">
			    <div class="form-group">
			        <label class="col-sm-3 control-label">分类名称：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			    ...
			    <div class="form-group">
			        ...
			        <div class="col-sm-4">
			        	<input class="form-control url" name="link" value="<?php echo ($info["link"]); ?>">
			        </div>
			    </div>
			    <div class="form-group">
