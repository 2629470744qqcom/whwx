...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> <h3 class="page-header">积分设置</h3></div>
<div class="row">
	<div class="panel panel-default">
		<div class="panel-body">
			<form id="myform" class="form-horizontal">
				<div class="form-group">
			        <label class="col-sm-3 control-label">兑换<?php echo C('money');?>元需积分：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required digits" name="point" value="<?php echo C('point');?>">
			        </div>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">注册送积分：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required digits" name="reg_point" value="<?php echo C('reg_point');?>">
			        </div>
			        <small>0表示不送积分</small>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">评价送积分：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required digits" name="score_point" value="<?php echo C('score_point');?>">
			        </div>
			        <small>0表示不送积分（仅限于报修、特惠团评价）</small>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">发帖送积分：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required digits" placeholder='输入0表示不送积分'  name="post" value="<?php echo C('post');?>">
			        </div>
			        
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">发帖送积分上限：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required digits" placeholder='输入0表示无上限' name="max_post" value="<?php echo C('max_post');?>">
			        </div>
			        
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">回复送积分：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required digits" placeholder='输入0表示不送积分'  name="reply" value="<?php echo C('reply');?>">
			        </div>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">回复送积分上限：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required digits" placeholder='输入0表示无上限' name="max_reply" value="<?php echo C('max_reply');?>">
			        </div>
			    </div>
			    <input type="hidden" name="money" value="<?php echo C('money');?>" />
		        <div class="form-group">
