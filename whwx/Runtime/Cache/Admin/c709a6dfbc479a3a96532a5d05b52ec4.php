                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td title="<?php echo ($list["content"]); ?>"><?php echo (msubstr($list["content"],0, 30)); ?></td>
                                    <td><?php echo (date('Y-m-d H:i', $list["times"])); ?></td>
                                    <td>
                                     	<button class="btn-sm btn btn-default editText" data-id='<?php echo ($list["id"]); ?>' >修改</button>
                                     	<button data-url='<?php echo U("Wxtext/del?id=".$list["id"]);?>' class="btn-sm btn btn-default delBtn" type="button">删除</button>
                                    </td>
...
<div id="myModal" class="modal fade in" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
	        <form action="<?php echo U('Wxtext/add');?>" id="myform" class="form-horizontal">
