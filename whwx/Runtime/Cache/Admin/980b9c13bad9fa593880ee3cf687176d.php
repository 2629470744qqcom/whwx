...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> <h3 class="page-header">图文回复</h3></div>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
            	<label><a href="<?php echo U('Wximg/add');?>" class="btn btn-primary">添加</a></label>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="<?php echo ($list["link"]); ?>" target="_blank">点击查看</a></td>
                                    <td><?php if(!empty($list["ids"])): ?>多图文<?php else: ?>单图文<?php endif; ?></td>
                                    <td><?php echo (date('Y-m-d H:i', $list["times"])); ?></td>
                                    <td>
                                     	<a href="<?php echo U('Wximg/edit', array('id' => $list['id']));?>" class="btn-sm btn btn-default">修改</a>
                                     	<button data-url='<?php echo U("Wximg/del?id=".$list["id"]);?>' class="btn-sm btn btn-default delBtn" type="button">删除</button>
                                    </td>
