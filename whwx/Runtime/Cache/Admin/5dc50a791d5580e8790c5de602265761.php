...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> 
	<h3 class="page-header">员工管理&nbsp;&nbsp;
		<small><?php if(($info["id"]) > "0"): ?>修改<?php else: ?>添加<?php endif; ?>员工</small>
	</h3>
</div>
<div class="row">
		...
		<div class="panel-body">
			<form role="form" id="myform" method="post"  class="form-horizontal">
			    <div class="form-group">
			        <label class="col-sm-3 control-label">员工名称：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required" name="name" value="<?php echo ($info["name"]); ?>" maxlength='20'>
			        </div>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">员工密码：<?php if(($info["id"]) <= "0"): ?><span class="c-red">*</span><?php endif; ?></label>
			        <div class="col-sm-4">
			        	<input type="password" id="pwd" class="form-control <?php if(($info["id"]) <= "0"): ?>required<?php endif; ?> " name="pwd" maxlength='15' minlength='6'>
			        </div>
			        <?php if(($info["id"]) > "0"): ?><small>若不修改密码，此处请留空</small><?php endif; ?>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">确认密码：</label>
			        <div class="col-sm-4">
			        	<input type="password" class="form-control" equalTo="#pwd" name="pwd2" maxlength='15' minlength='6'>
			        </div>
			        <?php if(($info["id"]) > "0"): ?><small>若不修改密码，此处请留空</small><?php endif; ?>
			    </div>
			    <div class="form-group">
			        ...
			        <div class="col-sm-4">
			        	<input class="form-control required" name="tel" value="<?php echo ($info["tel"]); ?>" maxlength='11'>
			        </div>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">选择所属组：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<select class="form-control" id="gid" name="gid">
			        		<?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><option value="<?php echo ($group["id"]); ?>"<?php if(($group["id"]) == $info["gid"]): ?>selected<?php endif; ?> ><?php echo ($group["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
			        </div>
			    </div>
			    <div class="form-group">
		           ...
		           <div class="col-sm-4">
		           		<textarea rows="3" class="form-control" name="remark" maxlength='20'><?php echo ($info["remark"]); ?></textarea>
		           </div>
		        </div>
		        ...
		        <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
				        <button class="btn btn-primary" type="submit">提交</button>
				       	<a href="<?php echo U('Admins/index');?>"><button class=" btn btn-default" type="button">返回</button></a>
		       		</div>
		       	</div>
			</form>
		</div>
