...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> 
	<h3 class="page-header">有偿服务&nbsp;&nbsp;<small><?php if(($info["id"]) > "0"): ?>修改<?php else: ?>添加<?php endif; ?>有偿服务</small></h3>
</div>
<div class="row">
		...
		<div class="panel-body">
			<form role="form" id="myform" method="post"  class="form-horizontal">
			    <div class="form-group">
			        <label class="col-sm-3 control-label">服务项目名称：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required" name="name" value="<?php echo ($info["name"]); ?>" maxlength='30'>
			        </div>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">材料费：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required" name="material" value="<?php echo ($info["material"]); ?>" maxlength='30'>
			        </div>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">人工机械费：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="required" name="price" value="<?php echo ($info["price"]); ?>" maxlength='10'>元
			        </div>
			    </div>
			    <div class="form-group">
			    ...
			    <div class="form-group">
		           ...
		           <div class="col-sm-4">
		           		<textarea rows="3" class="form-control" name="desc" maxlength='200'><?php echo ($info["desc"]); ?></textarea>
		           </div>
		        </div>
		        ...
		        <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
				        <button class="btn btn-primary" type="submit">提交</button>
				       	<a href="<?php echo U('RepairFixe/index');?>"><button class=" btn btn-default" type="button">返回</button></a>
		       		</div>
		       	</div>
			</form>
		</div>
