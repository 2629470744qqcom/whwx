...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> 
	<h3 class="page-header">轮播图&nbsp;&nbsp;<small><?php if(($info["id"]) > "0"): ?>修改<?php else: ?>添加<?php endif; ?>轮播图</small></h3>
</div>
<div class="row">
		...
		<div class="panel-body">
			<form role="form" id="myform" method="post"  class="form-horizontal">
			    ...
			    <div class="form-group">
                	...
                	<small>建议尺寸：360*200</small>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">小区：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
						<?php if(is_array($areaList)): $i = 0; $__LIST__ = $areaList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$area): $mod = ($i % 2 );++$i;?><label class="radio-inline">
				                <input type="checkbox" value="<?php echo ($area["id"]); ?>" id="aid<?php echo ($area["id"]); ?>" name="aid[]" <?php if(in_array($area['id'], $info['aids'])){echo checked;} ?> ><?php echo ($area["name"]); ?>
			    ...
			    <div class="form-group">
			        ...
			        <div class="col-sm-4">
			        	<input class="form-control url" name="url" value="<?php echo ($info["url"]); ?>">
			        </div>
			    </div>
			    <div class="form-group">
		        ...
		        <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
				        <button class="btn btn-primary" type="submit">提交</button>
				       	<a href="<?php echo U('Slide/index');?>"><button class=" btn btn-default" type="button">返回</button></a>
		       		</div>
		       	</div>
			</form>
		</div>
