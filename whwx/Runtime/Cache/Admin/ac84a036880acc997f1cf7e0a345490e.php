...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> <h3 class="page-header">图文回复<small><?php if(($info["id"]) > "0"): ?>/修改<?php else: ?>/添加<?php endif; ?></small></h3></div>
<div class="row">
		...
		<div class="panel-body">
			<form id="myform" class="form-horizontal">
			    <div class="form-group">
			        ...
			        <div class="col-sm-4">
			        	<input class="form-control required" name="keyword" value="<?php echo ($info["keyword"]); ?>" maxlength="10">
			        </div>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">图文标题：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required" name="title" value="<?php echo ($info["title"]); ?>">
			        </div>
			    </div>
			    <div class="form-group">
			       <label class="col-sm-3 control-label">图文封面：</label>
			       <div class="col-sm-4">
			       		...
			       		<small>建议尺寸880*400像素</small>
			       </div>
			    </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">链接地址：<span class="c-red">*</span></label>
			        <div class="col-sm-4">
			        	<input class="form-control required url" name="link" value="<?php echo ($info["link"]); ?>">
			        </div>
			    </div>
			    <div class="form-group">
			    	<label class="col-sm-3 control-label">图文简介：</label>
			    	<div class="col-sm-4">
			    		<textarea rows="3" class="form-control" name="desc"><?php echo ($info["desc"]); ?></textarea>
			    	</div>
		        </div>
			    <div class="form-group">
			        <label class="col-sm-3 control-label">多图文：</label>
			        <div class="col-sm-4">
			        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div>
				        	<input type="checkbox" name="ids[]" value="<?php echo ($list["id"]); ?>" id="imgs<?php echo ($list["id"]); ?>"> 
				        	<label for="imgs<?php echo ($list["id"]); ?>"><?php echo ($list["title"]); ?></label>
		        ...
		        <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
				        <button class="btn btn-primary" type="submit">保存</button>
				       	<a href="<?php echo U('Wximg/index');?>"><button class=" btn btn-default" type="button">返回</button></a>
			       	</div>	
		       	</div>
