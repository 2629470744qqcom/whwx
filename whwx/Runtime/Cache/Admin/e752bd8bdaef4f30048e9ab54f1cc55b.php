...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> 
	<h3 class="page-header">节点管理&nbsp;&nbsp;<small><?php if(($info["id"]) > "0"): ?>修改<?php else: ?>添加<?php endif; ?>节点</small></h3>
</div>
<div class="row">
		...
		<div class="panel-body">
			<form role="form" id="myform" method="post"  class="form-horizontal">
				<div class="form-group">
			        ...
			        <div class="col-sm-4">
			        	<select class="form-control" id="pid" name="pid">
			        		...
			        		<?php if(is_array($nodeList)): $i = 0; $__LIST__ = $nodeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><option value="<?php echo ($node["id"]); ?>"<?php if(($node["id"]) == $info["pid"]): ?>selected<?php endif; ?> ><?php if(($node["pid"]) == "0"): ?>&nbsp;|-&nbsp;&nbsp;<?php else: ?>&nbsp;|&nbsp;&nbsp;|-&nbsp;&nbsp;<?php endif; echo ($node["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>           
			        </div>
			    </div>
			    <div class="form-group">
			    ...
			    <div class="form-group">
			        ...
			        <div class="col-sm-4">
			        	<input class="form-control required" name="name" value="<?php echo ($info["name"]); ?>" maxlength='40'>
			        </div>
			        <small>填写格式:模块/控制器/方法(需保证唯一性)</small>
			    </div>
			    <div class="form-group">
					<label  class="col-sm-3 control-label">节点类型：</label>
					<div class="col-sm-4">
			            <label class="radio-inline">
			                <input type="radio" value="0" id="type0" name="type" <?php if(($info["type"]) < "1"): ?>checked<?php endif; ?>>一级菜单
			            </label>
			            <label class="radio-inline">
			                <input type="radio" value="1"  id="type1" name="type" <?php if(($info["type"]) == "1"): ?>checked<?php endif; ?>>二级菜单
			            </label>
			            <label class="radio-inline">
			                <input type="radio" value="2"  id="type2" name="type" <?php if(($info["type"]) == "2"): ?>checked<?php endif; ?>>隐藏
			            </label>
		            </div>
		        </div>
			    <div class="form-group">
			    ...
			    <div class="form-group">
		           ...
		           <div class="col-sm-4">
		           		<textarea rows="3" class="form-control" name="note" maxlength='20'><?php echo ($info["note"]); ?></textarea>
		           </div>
		        </div>
		        ...
		        <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
				        <button class="btn btn-primary" type="submit">提交</button>
				       	<a href="<?php echo U('Node/index');?>"><button class=" btn btn-default" type="button">返回</button></a>
		       		</div>
		       	</div>
			</form>
		</div>
