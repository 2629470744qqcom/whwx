...
<div id="wrapper">
    ...
    <div id="page-wrapper">
		<div id="page-inner">
	        <div class="row"> <h3 class="page-header">分享设置</h3></div>
<div class="row">
		...
		<div class="panel-body">
			<form id="myform" class="form-horizontal">
			    <div class="form-group">
			        ...
			        <div class="col-sm-4">
			        	<input class="form-control required" name="share_title" value="<?php echo C('share_title');?>">
			        </div>
			    </div>
			    <div class="form-group">
			    	...
			    	<div class="col-sm-4 imgreq">
			       		<div class="uploadify-div">
					    	<?php if(C('share_pic')){ echo '<li><img src="'.C('share_pic').'"><input type="hidden"  value="'.C('share_pic').'" name="share_pic"></li>'; } ?>
					    </div>
	                   	<button type="button" class='upload' id='upload1' data-name="share_pic">选择图片</button>
                	</div>
			    </div>
			    <div class="form-group">
		            <label class="col-sm-3 control-label">说明：</label>
		            <div class="col-sm-4">
		           		<textarea rows="3" class="form-control" name="share_desc"><?php echo C('share_desc');?></textarea>
		            </div>
